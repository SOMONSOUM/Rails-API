...
class Api::ProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_product" do
    assert_difference('Api::Product.count') do
      post api_products_url, params: { api_product: { name: @api_product.name, upc: @api_product.upc } }, as: :json
    end
  ...
  test "should update api_product" do
    patch api_product_url(@api_product), params: { api_product: { name: @api_product.name, upc: @api_product.upc } }, as: :json
    assert_response 200
  end
